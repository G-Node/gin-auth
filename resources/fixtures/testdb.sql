...
INSERT INTO Accounts (uuid, login, pwHash, email, isEmailPublic, firstName, lastName, institute, department, city, country, isAffiliationPublic, activationCode, createdAt, updatedAt) VALUES
  ('bf431618-f696-4dca-a95d-882618ce4ef9', 'alice', '', 'aclic@foo.com', FALSE, 'Alice', 'Goodchild', 'LMU', 'Biology II', 'Munich', 'Germany', FALSE, NULL, '2015-01-01 01:00:00', '2015-02-02 01:00:00'),
  ('51f5ac36-d332-4889-8023-6e033fcd8e17', 'bob', '', 'bob@foo.com', FALSE, 'Bob', 'Beaver', 'LMU', 'Biology II', 'Munich', 'Germany', TRUE, NULL, '2015-01-01 01:00:00', '2015-02-02 01:00:00');
-- Set pw to 'testtest'
